        ...
        <div className="relative z-10 py-8">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="relative flex flex-col items-center space-y-3">
              {/* logo */}
              <div className="relative w-38 h-38 mb-2">
                <Image
              ...
              {/* Brand name - XY with ultra fancy effects */}
              ...
              <div className="relative">
                <h2 className="relative text-xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-sky-500 via-blue-500 to-indigo-500 tracking-widest transform hover:scale-102 transition-all duration-300">
                  拼豆底稿生成器
                </h2>
              </div>
            </div>
            ...
            <div className="absolute -top-10 -left-10 w-3 h-3 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-full animate-float"></div>
            <div className="absolute -top-8 -left-6 w-1.5 h-1.5 bg-gradient-to-br from-cyan-400 to-blue-500 rotate-45 animate-spin delay-100"></div>
            <div className="absolute -top-6 -left-12 w-2 h-2 bg-gradient-to-br from-blue-400 to-sky-500 rounded-full animate-bounce delay-200"></div>

            <div className="absolute -top-10 -right-10 w-2.5 h-2.5 bg-gradient-to-br from-sky-400 to-blue-500 rounded-full animate-ping delay-300"></div>
            <div className="absolute -top-6 -right-14 w-1 h-1 bg-gradient-to-br from-blue-400 to-indigo-500 rotate-45 animate-pulse delay-400"></div>
            <div className="absolute -top-4 -right-8 w-3 h-3 bg-gradient-to-br from-indigo-400 to-blue-500 rounded-full animate-bounce delay-500"></div>

            <div className="absolute -bottom-10 -left-10 w-2 h-2 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-full animate-pulse delay-600"></div>
            <div className="absolute -bottom-8 -left-14 w-1.5 h-1.5 bg-gradient-to-br from-cyan-400 to-sky-500 rotate-45 animate-spin delay-700"></div>
            <div className="absolute -bottom-6 -left-6 w-2.5 h-2.5 bg-gradient-to-br from-sky-400 to-blue-500 rounded-full animate-float delay-800"></div>

            <div className="absolute -bottom-10 -right-10 w-3 h-3 bg-gradient-to-br from-indigo-400 to-blue-500 rotate-45 animate-bounce delay-900"></div>
            <div className="absolute -bottom-8 -right-6 w-1 h-1 bg-gradient-to-br from-blue-400 to-sky-500 rounded-full animate-ping delay-1000"></div>
            <div className="absolute -bottom-6 -right-14 w-2 h-2 bg-gradient-to-br from-sky-400 to-cyan-500 rounded-full animate-pulse delay-1100"></div>
            
            {/* Extra tiny magical sparkles */}
            <div className="absolute -top-12 left-0 w-0.5 h-0.5 bg-blue-300 rounded-full animate-ping delay-1200"></div>
            <div className="absolute -top-2 -left-16 w-1 h-1 bg-sky-300 rounded-full animate-bounce delay-1300"></div>
            <div className="absolute top-2 -right-18 w-0.5 h-0.5 bg-cyan-300 rounded-full animate-pulse delay-1400"></div>
            <div className="absolute -bottom-12 right-0 w-1 h-1 bg-indigo-300 rounded-full animate-float delay-1500"></div>
            <div className="absolute -bottom-2 -right-16 w-0.5 h-0.5 bg-blue-300 rounded-full animate-ping delay-1600"></div>
            <div className="absolute bottom-2 -left-18 w-1 h-1 bg-sky-300 rounded-full animate-bounce delay-1700"></div>
          </div>
          {/* Slogan */}
